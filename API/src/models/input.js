...
const OptionSchema = new Schema( { label: { type: String, required: true } , value: { type: String, required: true } } );

const InputTypes = ['Number','Text','Options'];
...
const inputSchema = mongoose.Schema({
	...
	weigh: { type: Number , required: false },
